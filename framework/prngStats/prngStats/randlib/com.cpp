...
int Common::Xm1, Common::Xm2;
int Common::Xa1, Common::Xa2;
int Common::Xcg1[numg], Common::Xcg2[numg];
int Common::Xa1w, Common::Xa2w;
int Common::Xig1[numg], Common::Xig2[numg];
int Common::Xlg1[numg], Common::Xlg2[numg];
int Common::Xa1vw, Common::Xa2vw;
bool Common::Xqanti[numg];
