...
namespace org.systemsbiology.math
{
	...
	public class DoubleVector
	{
		...
		{
			Debug.Assert(vec.Length > 0, "computing the maximum of a vector requires non-zero length");
			//UPGRADE_TODO: The equivalent in .NET for field 'java.lang.Double.MAX_VALUE' may return a different value. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1043'"
			double retVal = (- 1.0) * System.Double.MaxValue;
		...
		public static void  add(double[] addendX, double[] addendY, double[] sum)
		{
			...
			Debug.Assert(size1 == size2 && size2 == size3, "inconsistent vector size");
		...
		public static void  scalarMultiply(double[] vector, double scalar, double[] product)
		{
			...
			Debug.Assert(size1 == size2, "inconsistent vector size");
