...
namespace cern.colt.function
{
	...
	{
		/// <summary> Applies a procedure to two arguments.
		...
		///
		/// </summary>
		/// <param name="first">  first argument passed to the procedure.
		/// </param>
		/// <param name="second">  second argument passed to the procedure.
		/// </param>
