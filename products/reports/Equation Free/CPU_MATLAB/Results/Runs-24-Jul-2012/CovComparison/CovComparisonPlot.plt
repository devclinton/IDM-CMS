cd 'C:\tmp\eqfTestSuiteNetwork\Results\Runs-24-Jul-2012\CovComparison'   
...
plot "SSAEndemic.dat" u 1:(($5-$15)):(($5+$15)) w filledcurves ls 1, "SSAEndemic.dat" u 1:($5) w l ls 1, \
	"CovEndemic.dat" u 1:(($5-$15)):(($5+$15)) w filledcurves ls 2, "CovEndemic.dat" u 1:($5) w l ls 2
...
plot "SSAVaccinate.dat" u 1:(($5-$15)):(($5+$15)) w filledcurves, "SSAVaccinate.dat" u 1:($5) w l ls 1, \
	"CovVaccinate.dat" u 1:(($5-$15)):(($5+$15)) w filledcurves, "CovVaccinate.dat" u 1:($5) w l ls 2
...
set yrange [0:1]
set ytic 0,0.2
plot "SSAVaccinate.dat" u 1:($22/10000) w l ls 1, "CovVaccinate.dat" u 1:22 w l ls 2
