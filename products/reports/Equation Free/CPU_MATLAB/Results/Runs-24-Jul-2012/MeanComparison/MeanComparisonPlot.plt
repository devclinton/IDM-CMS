cd 'C:\tmp\eqfTestSuiteNetwork\Results\Runs-24-Jul-2012\MeanComparison'   
...
plot "SSAEndemic.dat" u 1:(($5-$15)):(($5+$15)) w filledcurves ls 1, "SSAEndemic.dat" u 1:($5) w l ls 1, \
	"MeanEndemic.dat" u 1:(($5-$15)):(($5+$15)) w filledcurves ls 2, "MeanEndemic.dat" u 1:($5) w l ls 2
...
plot "SSAVaccinate.dat" u 1:(($5-$15)):(($5+$15)) w filledcurves, "SSAVaccinate.dat" u 1:($5) w l ls 1, \
	"MeanVaccinate.dat" u 1:(($5-$15)):(($5+$15)) w filledcurves, "MeanVaccinate.dat" u 1:($5) w l ls 2
...
set yrange [0:1]
set ytic 0,0.2
plot "SSAVaccinate.dat" u 1:($22/10000) w l ls 1, "MeanVaccinate.dat" u 1:22 w l ls 2
