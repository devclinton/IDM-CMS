...
omega=1.0; density=1.0; t1=4/9; t2=1/9; t3=1/36; c_squ=1/3; nx=101; ny=101;
...
BOUND=rand(nx,ny)>0.8; %extremely porous random domain
...
%title(['Flow field after ',num2str(ts),'\deltat']);xlabel('x');ylabel('y');
 pcolor(2:nx,1:ny,UX(2:nx,:)'.^2+UY(2:nx,:)'.^2)
 shading interp