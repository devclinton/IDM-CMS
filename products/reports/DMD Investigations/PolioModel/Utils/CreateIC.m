...
x = inv(A) * B;
    ...
    IC = [round(x*param.N*pa.accessGroupPercent(1));  
          round(x*param.N*pa.accessGroupPercent(2)); 
          round(x*param.N*pa.accessGroupPercent(3)); 
          round(x*param.N*pa.accessGroupPercent(4)); 
          zeros(pa.InfectedWildComp*pa.numberOfAgeGroups ...
          + pa.InfectedWildComp*pa.numberOfAgeGroups ...
