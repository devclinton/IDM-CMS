...
project = u'Compartmental Modeling (CMS)'
copyright = u'2017, Intellectual Ventures Management, LLC (IVM). All rights reserved'
...
htmlhelp_basename = 'Compartmental Modeling (CMS)'
...
latex_documents = [
    (master_doc, 'idm-cms-docs.tex', u'Compartmental Modeling (CMS)',
...
man_pages = [
    (master_doc, 'idm-cms-docs', u'Compartmental Modeling (CMS)',
     [author], 1)
]
